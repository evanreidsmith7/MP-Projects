 ...
 * The purpose of this header file is to establish common defines
 * for the non-printable ASCII characters to make referencing them easier.
 * For example, the escape character, ASCII 27, may be referred to simple as ESC.
 */

 /*removing the definition for NULL.  This appears to conflict for the Arduino compiler. */
/*
#ifndef NULL
#define NULL 0
#endif
